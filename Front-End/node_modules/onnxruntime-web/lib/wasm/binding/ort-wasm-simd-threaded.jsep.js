...
var T,Ga={893660:()=>{B.jsepRunPromise=new Promise(function(a){B.tb=a})},893755:a=>{B.tb(a)},893793:a=>B.ob(a),893826:a=>B.qb(a),893858:(a,b,c)=>{B.ab(a,b,c,!0)},893897:(a,b,c)=>{B.ab(a,b,c)},893930:a=>{B.xa("Abs",a,void 0)},893981:a=>{B.xa("Neg",a,void 0)},894032:a=>{B.xa("Floor",a,void 0)},894085:a=>{B.xa("Ceil",a,void 0)},894137:a=>{B.xa("Reciprocal",a,void 0)},894195:a=>{B.xa("Sqrt",a,void 0)},894247:a=>{B.xa("Exp",a,void 0)},894298:a=>{B.xa("Erf",a,void 0)},894349:a=>{B.xa("Sigmoid",a,void 0)},
894404:a=>{B.xa("Log",a,void 0)},894455:a=>{B.xa("Sin",a,void 0)},894506:a=>{B.xa("Cos",a,void 0)},894557:a=>{B.xa("Tan",a,void 0)},894608:a=>{B.xa("Asin",a,void 0)},894660:a=>{B.xa("Acos",a,void 0)},894712:a=>{B.xa("Atan",a,void 0)},894764:a=>{B.xa("Sinh",a,void 0)},894816:a=>{B.xa("Cosh",a,void 0)},894868:a=>{B.xa("Asinh",a,void 0)},894921:a=>{B.xa("Acosh",a,void 0)},894974:a=>{B.xa("Atanh",a,void 0)},895027:a=>{B.xa("Tanh",a,void 0)},895079:(a,b,c)=>{B.xa("ClipV10",a,{min:b,max:c})},895151:a=>
{B.xa("Clip",a,void 0)},895203:(a,b)=>{B.xa("Elu",a,{alpha:b})},895261:a=>{B.xa("Relu",a,void 0)},895313:(a,b)=>{B.xa("LeakyRelu",a,{alpha:b})},895377:(a,b)=>{B.xa("ThresholdedRelu",a,{alpha:b})},895447:(a,b)=>{B.xa("Cast",a,{to:b})},895505:a=>{B.xa("Add",a,void 0)},895556:a=>{B.xa("Sub",a,void 0)},895607:a=>{B.xa("Mul",a,void 0)},895658:a=>{B.xa("Div",a,void 0)},895709:a=>{B.xa("Pow",a,void 0)},895760:(a,b,c,e,f)=>{B.xa("ReduceMean",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>
0,f+e>>>0)):[]})},895924:(a,b,c,e,f)=>{B.xa("ReduceMax",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},896087:(a,b,c,e,f)=>{B.xa("ReduceMin",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},896250:(a,b,c,e,f)=>{B.xa("ReduceProd",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},896414:(a,b,c,e,f)=>{B.xa("ReduceSum",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>
0,f+e>>>0)):[]})},896577:(a,b,c,e,f)=>{B.xa("ReduceL1",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},896739:(a,b,c,e,f)=>{B.xa("ReduceL2",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},896901:(a,b,c,e,f)=>{B.xa("ReduceLogSum",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},897067:(a,b,c,e,f)=>{B.xa("ReduceSumSquare",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>
0,f+e>>>0)):[]})},897236:(a,b,c,e,f)=>{B.xa("ReduceLogSumExp",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},897405:(a,b,c)=>{B.xa("Transpose",a,{perm:b?Array.from(z().subarray(c>>>0,c+b>>>0)):[]})},897518:(a,b,c,e,f,h,k,m,v,n)=>{B.xa("Conv",a,{format:v?"NHWC":"NCHW",auto_pad:b,dilations:[c],group:e,kernel_shape:[f],pads:[h,k],strides:[m],w_is_const:()=>!!d()[n>>>0]})},897746:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t)=>{B.xa("Conv",a,{format:g?"NHWC":"NCHW",auto_pad:b,
dilations:[c,e],group:f,kernel_shape:[h,k],pads:[m,v,n,r],strides:[x,y],w_is_const:()=>!!d()[t>>>0]})},898005:(a,b,c,e,f,h,k,m,v,n)=>{B.xa("Conv",a,{format:v?"NHWC":"NCHW",auto_pad:b,dilations:[c],group:e,kernel_shape:[f],pads:[h,k],strides:[m],w_is_const:()=>!!d()[n>>>0]})},898233:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t)=>{B.xa("Conv",a,{format:g?"NHWC":"NCHW",auto_pad:b,dilations:[c,e],group:f,kernel_shape:[h,k],pads:[m,v,n,r],strides:[x,y],w_is_const:()=>!!d()[t>>>0]})},898492:(a,b,c,e,f,h,k,m,v,n,r,x,
y,g)=>{B.xa("ConvTranspose",a,{format:v?"NHWC":"NCHW",autoPad:b,dilations:[c],group:e,kernel_shape:[f],pads:[h,k],strides:[m],wIsConst:()=>!!d()[n>>>0],outputPadding:r?Array.from(z().subarray(x>>>0,x+r>>>0)):[],outputShape:y?Array.from(z().subarray(g>>>0,g+y>>>0)):[]})},898872:(a,b,c,e,f,h,k,m,v,n,r,x,y)=>{B.xa("ConvTranspose",a,{format:m?"NHWC":"NCHW",autoPad:b,dilations:Array.from(z().subarray(c>>>0,c+2>>>0)),group:e,kernelShape:Array.from(z().subarray(f>>>0,f+2>>>0)),pads:Array.from(z().subarray(h>>>
...
0)):[]})},899775:(a,b,c,e,f,h,k,m,v,n,r,x,y)=>{B.xa("ConvTranspose",a,{format:m?"NHWC":"NCHW",autoPad:b,dilations:Array.from(z().subarray(c>>>0,c+2>>>0)),group:e,kernelShape:Array.from(z().subarray(f>>>0,f+2>>>0)),pads:Array.from(z().subarray(h>>>0,h+4>>>0)),strides:Array.from(z().subarray(k>>>0,k+2>>>0)),wIsConst:()=>!!d()[v>>>0],outputPadding:0<n?Array.from(z().subarray(r>>>0,r+n>>>0)):[],outputShape:0<x?Array.from(z().subarray(y>>>0,y+x>>>0)):[]})},900298:(a,b)=>{B.xa("GlobalAveragePool",a,{format:b?
"NHWC":"NCHW"})},900389:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t,w)=>{B.xa("AveragePool",a,{format:w?"NHWC":"NCHW",auto_pad:b,ceil_mode:c,count_include_pad:e,storage_order:f,dilations:[h,k],kernel_shape:[m,v],pads:[n,r,x,y],strides:[g,t]})},900673:(a,b)=>{B.xa("GlobalAveragePool",a,{format:b?"NHWC":"NCHW"})},900764:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t,w)=>{B.xa("AveragePool",a,{format:w?"NHWC":"NCHW",auto_pad:b,ceil_mode:c,count_include_pad:e,storage_order:f,dilations:[h,k],kernel_shape:[m,v],pads:[n,r,x,y],strides:[g,
t]})},901048:(a,b)=>{B.xa("GlobalMaxPool",a,{format:b?"NHWC":"NCHW"})},901135:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t,w)=>{B.xa("MaxPool",a,{format:w?"NHWC":"NCHW",auto_pad:b,ceil_mode:c,count_include_pad:e,storage_order:f,dilations:[h,k],kernel_shape:[m,v],pads:[n,r,x,y],strides:[g,t]})},901415:(a,b)=>{B.xa("GlobalMaxPool",a,{format:b?"NHWC":"NCHW"})},901502:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t,w)=>{B.xa("MaxPool",a,{format:w?"NHWC":"NCHW",auto_pad:b,ceil_mode:c,count_include_pad:e,storage_order:f,dilations:[h,
k],kernel_shape:[m,v],pads:[n,r,x,y],strides:[g,t]})},901782:(a,b,c,e,f)=>{B.xa("Gemm",a,{alpha:b,beta:c,transA:e,transB:f})},901886:a=>{B.xa("MatMul",a,void 0)},901940:(a,b,c,e)=>{B.xa("ArgMax",a,{keepDims:!!b,selectLastIndex:!!c,axis:e})},902048:(a,b,c,e)=>{B.xa("ArgMin",a,{keepDims:!!b,selectLastIndex:!!c,axis:e})},902156:(a,b)=>{B.xa("Softmax",a,{axis:b})},902219:(a,b)=>{B.xa("Concat",a,{axis:b})},902279:(a,b,c,e,f)=>{B.xa("Split",a,{axis:b,numOutputs:c,splitSizes:e?Array.from(z().subarray(f>>>
0,f+e>>>0)):[]})},902424:a=>{B.xa("Expand",a,void 0)},902478:(a,b)=>{B.xa("Gather",a,{axis:Number(b)})},902549:(a,b,c,e,f,h,k,m,v,n,r)=>{B.xa("Resize",a,{antialias:b,axes:c?Array.from(z().subarray(e>>>0,e+c>>>0)):[],coordinateTransformMode:U(f),cubicCoeffA:h,excludeOutside:k,extrapolationValue:m,keepAspectRatioPolicy:U(v),mode:U(n),nearestMode:U(r)})},902900:(a,b,c,e,f,h,k)=>{B.xa("Slice",a,{starts:b?Array.from(z().subarray(c>>>0,c+b>>>0)):[],ends:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[],axes:h?
Array.from(z().subarray(k>>>0,k+h>>>0)):[]})},903131:a=>{B.xa("Tile",a,void 0)},903183:(a,b,c)=>{B.xa("LayerNormalization",a,{axis:Number(b),epsilon:Number(c)})},903290:(a,b,c)=>{B.xa("InstanceNormalization",a,{epsilon:b,format:c?"NHWC":"NCHW"})},903404:(a,b,c)=>{B.xa("InstanceNormalization",a,{epsilon:b,format:c?"NHWC":"NCHW"})},903518:a=>{B.xa("Gelu",a,void 0)},903570:(a,b)=>{B.xa("SkipLayerNormalization",a,{epsilon:b})},903651:a=>{B.rb(a)},903685:(a,b)=>B.sb(a,b)};
...
var Gb=(a,b,c,e)=>(Gb=M.Aa)(a,b,c,e),Qa=a=>(Qa=M.Ba)(a),Xa=B.__emscripten_thread_exit=a=>(Xa=B.__emscripten_thread_exit=M.Ca)(a),ub=B.__emscripten_check_mailbox=()=>(ub=B.__emscripten_check_mailbox=M.Da)(),tc=a=>(tc=M.Ea)(a),Ua=(a,b)=>(Ua=M.Fa)(a,b),Db=()=>(Db=M.Ga)(),Va=a=>(Va=M.Ha)(a),Fb=a=>(Fb=M.Ia)(a),Wa=B.dynCall_ii=(a,b)=>(Wa=B.dynCall_ii=M.Ka)(a,b),nc=a=>(nc=M.La)(a),cc=()=>(cc=M.Ma)(),mc=a=>(mc=M.Na)(a),oc=()=>(oc=M.Oa)();B.___start_em_js=903720;B.___stop_em_js=903881;
